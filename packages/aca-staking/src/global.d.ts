...
declare module "@polkadot/api-base/types/storage" {
  interface AugmentedQueries<ApiType extends ApiTypes> {
      ...
      rawValues: AugmentedQuery<
        ...
        (
          ...
          arg2:
            ...
            | string
            | Uint8Array,
        ) => Observable<Option<OrmlOracleModuleTimestampedValue>>,
    ...
    aggregatedDex: {
      aggregatedSwapPaths: AugmentedQuery<
        ApiType,
        (
          arg:
            | ITuple<
        ...
        ) => Observable<Option<Vec<ModuleSupportDexAggregatedSwapPath>>>,
        [
          ITuple<
            [
              AcalaPrimitivesCurrencyCurrencyId,
      ...
      assetMetadatas: AugmentedQuery<
        ...
        (
          arg:
            ...
            | string
            | Uint8Array,
        ) => Observable<Option<AcalaPrimitivesCurrencyAssetMetadata>>,
        [AcalaPrimitivesCurrencyAssetIds]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyAssetIds]>;
      erc20IdToAddress: AugmentedQuery<
        ApiType,
        (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<H160>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      foreignAssetLocations: AugmentedQuery<
        ApiType,
        (
          arg: u16 | AnyNumber | Uint8Array,
        ) => Observable<Option<StagingXcmV3MultiLocation>>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      locationToCurrencyIds: AugmentedQuery<
        ApiType,
        (
          arg:
            | StagingXcmV3MultiLocation
            ...
            | string
            | Uint8Array,
        ) => Observable<Option<AcalaPrimitivesCurrencyCurrencyId>>,
        [StagingXcmV3MultiLocation]
      > &
        QueryableStorageEntry<ApiType, [StagingXcmV3MultiLocation]>;
      nextForeignAssetId: AugmentedQuery<ApiType, () => Observable<u16>, []> &
        QueryableStorageEntry<ApiType, []>;
      nextStableAssetId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    auction: {
      ...
      auctions: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<OrmlTraitsAuctionAuctionInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      auctionsIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    auctionManager: {
      collateralAuctions: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<ModuleAuctionManagerCollateralAuctionItem>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      totalCollateralInAuction: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
      ...
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
      totalTargetInAuction: AugmentedQuery<
        ApiType,
        () => Observable<u128>,
        []
      > &
    ...
    authority: {
      nextTaskIndex: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      savedCalls: AugmentedQuery<
        ApiType,
        (
          arg: H256 | string | Uint8Array,
        ) => Observable<Option<ITuple<[Call, Option<AccountId32>]>>>,
        [H256]
      > &
    ...
    balances: {
      ...
      freezes: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Vec<FrameSupportTokensMiscIdAmount>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
    ...
    cdpEngine: {
      collateralParams: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
            ...
            | string
            | Uint8Array,
        ) => Observable<Option<ModuleCdpEngineRiskManagementParams>>,
        [AcalaPrimitivesCurrencyCurrencyId]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
      debitExchangeRate: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
      ...
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
      lastAccumulationSecs: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      liquidationContracts: AugmentedQuery<
        ApiType,
        () => Observable<Vec<H160>>,
        []
      > &
    ...
    cdpTreasury: {
      debitOffsetBuffer: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      debitPool: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      expectedCollateralAuctionSize: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
    ...
    collatorSelection: {
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      nonCandidates: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<u32>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      sessionPoints: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<u32>,
        [AccountId32]
      > &
    ...
    dex: {
      initialShareExchangeRates: AugmentedQuery<
        ApiType,
        (arg: AcalaPrimitivesTradingPair) => Observable<ITuple<[u128, u128]>>,
        [AcalaPrimitivesTradingPair]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesTradingPair]>;
      ...
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesTradingPair]>;
      provisioningPool: AugmentedQuery<
        ApiType,
        (
          arg1: AcalaPrimitivesTradingPair,
          arg2: AccountId32 | string | Uint8Array,
        ) => Observable<ITuple<[u128, u128]>>,
        [AcalaPrimitivesTradingPair, AccountId32]
      > &
        QueryableStorageEntry<
          ApiType,
          [AcalaPrimitivesTradingPair, AccountId32]
      ...
      tradingPairStatuses: AugmentedQuery<
        ApiType,
        (
          arg: AcalaPrimitivesTradingPair,
        ) => Observable<ModuleDexTradingPairStatus>,
        [AcalaPrimitivesTradingPair]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesTradingPair]>;
      /**
    ...
    dexOracle: {
      averagePrices: AugmentedQuery<
        ApiType,
        (
          arg: AcalaPrimitivesTradingPair,
        ) => Observable<Option<ITuple<[u128, u128, U256, U256, u64, u64]>>>,
        [AcalaPrimitivesTradingPair]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesTradingPair]>;
      cumulatives: AugmentedQuery<
        ApiType,
        (
          arg: AcalaPrimitivesTradingPair,
        ) => Observable<ITuple<[U256, U256, u64]>>,
        [AcalaPrimitivesTradingPair]
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesTradingPair]>;
      /**
    ...
    earning: {
      ledger: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<AcalaPrimitivesBondingLedgerBondingLedger>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    emergencyShutdown: {
      canRefund: AugmentedQuery<ApiType, () => Observable<bool>, []> &
        QueryableStorageEntry<ApiType, []>;
      isShutdown: AugmentedQuery<ApiType, () => Observable<bool>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    evm: {
      accounts: AugmentedQuery<
        ...
        ) => Observable<Option<ModuleEvmModuleAccountInfo>>,
        [H160]
      > &
      ...
      chainId: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      codeInfos: AugmentedQuery<
        ApiType,
        (
          arg: H256 | string | Uint8Array,
        ) => Observable<Option<ModuleEvmModuleCodeInfo>>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      codes: AugmentedQuery<
        ApiType,
        (arg: H256 | string | Uint8Array) => Observable<Bytes>,
        [H256]
      > &
        QueryableStorageEntry<ApiType, [H256]>;
      contractStorageSizes: AugmentedQuery<
        ApiType,
        (arg: H160 | string | Uint8Array) => Observable<u32>,
        [H160]
      > &
        QueryableStorageEntry<ApiType, [H160]>;
      extrinsicOrigin: AugmentedQuery<
        ApiType,
        () => Observable<Option<AccountId32>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      networkContractIndex: AugmentedQuery<ApiType, () => Observable<u64>, []> &
        QueryableStorageEntry<ApiType, []>;
      xcmOrigin: AugmentedQuery<
        ApiType,
    ...
    homa: {
      bumpEraFrequency: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      commissionRate: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      estimatedRewardRatePerEra: AugmentedQuery<
        ApiType,
        () => Observable<u128>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      fastMatchFeeRate: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      lastEraBumpedBlock: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      nominateIntervalEra: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      redeemRequests: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<ITuple<[u128, bool]>>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      relayChainCurrentEra: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      softBondedCapPerSubAccount: AugmentedQuery<
        ApiType,
        () => Observable<u128>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      stakingLedgers: AugmentedQuery<
        ApiType,
        (
          arg: u16 | AnyNumber | Uint8Array,
        ) => Observable<Option<ModuleHomaModuleStakingLedger>>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
      toBondPool: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      totalStakingBonded: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      totalVoidLiquid: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      unbondings: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
      ...
      unclaimedRedemption: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      /**
       * Generic query
       **/
    ...
    homaValidatorList: {
      guarantees: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: AccountId32 | string | Uint8Array,
        ) => Observable<Option<ModuleHomaValidatorListGuarantee>>,
        [AccountId32, AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, AccountId32]>;
      totalLockedByGuarantor: AugmentedQuery<
        ApiType,
        (arg: AccountId32 | string | Uint8Array) => Observable<Option<u128>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      validatorBackings: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<ModuleHomaValidatorListValidatorBacking>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
    ...
    honzon: {
      authorization: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2:
            | ITuple<[AcalaPrimitivesCurrencyCurrencyId, AccountId32]>
            | [
                (
                  | AcalaPrimitivesCurrencyCurrencyId
                  | {
        ...
        [AccountId32, ITuple<[AcalaPrimitivesCurrencyCurrencyId, AccountId32]>]
      > &
        QueryableStorageEntry<
          ApiType,
          [
    ...
    idleScheduler: {
      nextTaskId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      previousRelayBlockNumber: AugmentedQuery<
        ApiType,
        () => Observable<u32>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      tasks: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<AcalaRuntimeScheduledTasks>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    incentives: {
      claimRewardDeductionCurrency: AugmentedQuery<
        ApiType,
        (
          arg:
            | ModuleSupportIncentivesPoolId
        ...
        [ModuleSupportIncentivesPoolId]
      > &
        QueryableStorageEntry<ApiType, [ModuleSupportIncentivesPoolId]>;
      ...
      > &
        QueryableStorageEntry<ApiType, [ModuleSupportIncentivesPoolId]>;
      incentiveRewardAmounts: AugmentedQuery<
        ApiType,
        (
          arg1:
            | ModuleSupportIncentivesPoolId
        ...
        [ModuleSupportIncentivesPoolId, AcalaPrimitivesCurrencyCurrencyId]
      > &
        QueryableStorageEntry<
          ApiType,
          [ModuleSupportIncentivesPoolId, AcalaPrimitivesCurrencyCurrencyId]
      ...
      pendingMultiRewards: AugmentedQuery<
        ...
        (
          arg1:
            ...
            | Uint8Array,
          arg2: AccountId32 | string | Uint8Array,
        ) => Observable<BTreeMap<AcalaPrimitivesCurrencyCurrencyId, u128>>,
        [ModuleSupportIncentivesPoolId, AccountId32]
      > &
        QueryableStorageEntry<
          ApiType,
          [ModuleSupportIncentivesPoolId, AccountId32]
    ...
    liquidCrowdloan: {
      redeemCurrencyId: AugmentedQuery<
        ApiType,
        () => Observable<Option<AcalaPrimitivesCurrencyCurrencyId>>,
        []
      > &
      ...
      positions: AugmentedQuery<
        ...
        (
          arg1:
            ...
            | Uint8Array,
          arg2: AccountId32 | string | Uint8Array,
        ) => Observable<AcalaPrimitivesPosition>,
        [AcalaPrimitivesCurrencyCurrencyId, AccountId32]
      > &
        QueryableStorageEntry<
          ApiType,
          [AcalaPrimitivesCurrencyCurrencyId, AccountId32]
        >;
      totalPositions: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
    ...
    nomineesElection: {
      ...
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      reservedNominees: AugmentedQuery<
        ApiType,
        (arg: u16 | AnyNumber | Uint8Array) => Observable<Vec<AccountId32>>,
        [u16]
      > &
        QueryableStorageEntry<ApiType, [u16]>;
    ...
    ormlNFT: {
      classes: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<OrmlNftClassInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      nextClassId: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      nextTokenId: AugmentedQuery<
        ApiType,
      ...
      tokens: AugmentedQuery<
        ...
        ) => Observable<Option<OrmlNftTokenInfo>>,
        [u32, u64]
      > &
        QueryableStorageEntry<ApiType, [u32, u64]>;
      tokensByOwner: AugmentedQuery<
        ApiType,
        (
          arg1: AccountId32 | string | Uint8Array,
          arg2: u32 | AnyNumber | Uint8Array,
        ...
        [AccountId32, u32, u64]
      > &
        QueryableStorageEntry<ApiType, [AccountId32, u32, u64]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    parachainSystem: {
      aggregatedUnincludedSegment: AugmentedQuery<
        ApiType,
        () => Observable<
          Option<CumulusPalletParachainSystemUnincludedSegmentSegmentTracker>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      ...
      unincludedSegment: AugmentedQuery<
        ApiType,
        () => Observable<
          Vec<CumulusPalletParachainSystemUnincludedSegmentAncestor>
        >,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      ...
      > &
        QueryableStorageEntry<ApiType, []>;
      upwardDeliveryFeeFactor: AugmentedQuery<
        ApiType,
        () => Observable<u128>,
        []
      > &
      ...
      parameters: AugmentedQuery<
        ...
        (
          arg:
            ...
            | string
            | Uint8Array,
        ) => Observable<Option<AcalaRuntimeRuntimeParametersValue>>,
        [AcalaRuntimeRuntimeParametersKey]
      > &
        QueryableStorageEntry<ApiType, [AcalaRuntimeRuntimeParametersKey]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
      ...
      poolInfos: AugmentedQuery<
        ...
        (
          arg:
            ...
            | string
            | Uint8Array,
        ) => Observable<OrmlRewardsPoolInfo>,
        [ModuleSupportIncentivesPoolId]
      > &
        QueryableStorageEntry<ApiType, [ModuleSupportIncentivesPoolId]>;
      sharesAndWithdrawnRewards: AugmentedQuery<
        ApiType,
        (
          arg1:
            | ModuleSupportIncentivesPoolId
          ...
          ITuple<[u128, BTreeMap<AcalaPrimitivesCurrencyCurrencyId, u128>]>
        >,
        [ModuleSupportIncentivesPoolId, AccountId32]
      > &
        QueryableStorageEntry<
    ...
    session: {
      ...
      nextKeys: AugmentedQuery<
        ...
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<AcalaRuntimeSessionKeys>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      ...
      queuedKeys: AugmentedQuery<
        ApiType,
        () => Observable<Vec<ITuple<[AccountId32, AcalaRuntimeSessionKeys]>>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
    ...
    sessionManager: {
      durationOffset: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      sessionDuration: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      sessionDurationChanges: AugmentedQuery<
        ApiType,
    ...
    stableAsset: {
      poolCount: AugmentedQuery<ApiType, () => Observable<u32>, []> &
        QueryableStorageEntry<ApiType, []>;
      pools: AugmentedQuery<
        ApiType,
        (
          arg: u32 | AnyNumber | Uint8Array,
        ) => Observable<Option<NutsfinanceStableAssetStableAssetPoolInfo>>,
        [u32]
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    transactionPause: {
      pausedEvmPrecompiles: AugmentedQuery<
        ApiType,
    ...
    transactionPayment: {
      alternativeFeeSwapPath: AugmentedQuery<
        ApiType,
        (
          arg: AccountId32 | string | Uint8Array,
        ) => Observable<Option<Vec<AcalaPrimitivesCurrencyCurrencyId>>>,
        [AccountId32]
      > &
        QueryableStorageEntry<ApiType, [AccountId32]>;
      globalFeeSwapPath: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
      ...
      nextFeeMultiplier: AugmentedQuery<ApiType, () => Observable<u128>, []> &
        QueryableStorageEntry<ApiType, []>;
      overrideChargeFeeMethod: AugmentedQuery<
        ApiType,
        () => Observable<Option<ModuleTransactionPaymentModuleChargeFeeMethod>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
      poolSize: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
      ...
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
      swapBalanceThreshold: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
      ...
      > &
        QueryableStorageEntry<ApiType, [AcalaPrimitivesCurrencyCurrencyId]>;
      tokenExchangeRate: AugmentedQuery<
        ApiType,
        (
          arg:
            | AcalaPrimitivesCurrencyCurrencyId
    ...
    xcmInterface: {
      xcmDestWeightAndFee: AugmentedQuery<
        ApiType,
        (
          arg:
            | ModuleXcmInterfaceModuleXcmInterfaceOperation
            ...
            | string
            | Uint8Array,
        ) => Observable<ITuple<[SpWeightsWeightV2Weight, u128]>>,
        [ModuleXcmInterfaceModuleXcmInterfaceOperation]
      > &
        QueryableStorageEntry<
          ApiType,
    ...
    xcmpQueue: {
      ...
      > &
        QueryableStorageEntry<ApiType, [u32]>;
      inboundXcmpSuspended: AugmentedQuery<
        ApiType,
        () => Observable<BTreeSet<u32>>,
        []
      > &
        QueryableStorageEntry<ApiType, []>;
